...
#ifdef QB64_WINDOWS
 #include "..\\temp4\\regsf.txt"
 #include "..\\temp4\\global.txt"
#else
 #include "../temp4/regsf.txt"
 #include "../temp4/global.txt"
#endif
...
#ifdef QB64_WINDOWS
 #include "..\\temp4\\dyninfo.txt"
#else
 #include "../temp4/dyninfo.txt"
#endif
}
...
#ifdef QB64_WINDOWS
 #include "..\\temp4\\clear.txt"
#else
 #include "../temp4/clear.txt"
#endif
...
//read COMMON data
#ifdef QB64_WINDOWS
 #include "..\\temp4\\inpchain.txt"
#else
 #include "../temp4/inpchain.txt"
#endif
...
#ifdef QB64_WINDOWS
 #include "..\\temp4\\chain.txt"
#else
 #include "../temp4/chain.txt"
#endif
...
switch(x){
#ifdef QB64_WINDOWS
 #include "..\\temp4\\onstrig.txt"
#else
 #include "../temp4/onstrig.txt"
#endif
//example.....
//case 1:
//...
...
switch(x){
#ifdef QB64_WINDOWS
 #include "..\\temp4\\onkey.txt"
#else
 #include "../temp4/onkey.txt"
#endif
//example.....
//case 1:
//...
...
#ifdef QB64_WINDOWS
 #include "..\\temp4\\ontimer.txt"
#else
 #include "../temp4/ontimer.txt"
#endif
//example.....
//case 1:
//...
...
#ifdef QB64_WINDOWS
 #include "..\\temp4\\maindata.txt"
 #include "..\\temp4\\runline.txt"
 #include "..\\temp4\\mainerr.txt"
 if (timer_event_occurred){
 timer_event_occurred--;
 #include "..\\temp4\\ontimerj.txt"
 }
 if (key_event_occurred){
 key_event_occurred--;
 #include "..\\temp4\\onkeyj.txt"
 }
 if (strig_event_occurred){
 strig_event_occurred--;
 #include "..\\temp4\\onstrigj.txt"
 }
 chain_input();
 #include "..\\temp4\\main.txt"
#else
 #include "../temp4/maindata.txt"
 #include "../temp4/runline.txt"
 #include "../temp4/mainerr.txt"
 if (timer_event_occurred){
 timer_event_occurred--;
 #include "../temp4/ontimerj.txt"
 }
 if (key_event_occurred){
 key_event_occurred--;
 #include "../temp4/onkeyj.txt"
 }
 if (strig_event_occurred){
 strig_event_occurred--;
 #include "../temp4/onstrigj.txt"
 }
 chain_input();
 #include "../temp4/main.txt"
#endif
