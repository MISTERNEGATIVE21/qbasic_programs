...
#ifdef QB64_WINDOWS
 #include "..\\temp7\\regsf.txt"
 #include "..\\temp7\\global.txt"
#else
 #include "../temp7/regsf.txt"
 #include "../temp7/global.txt"
#endif
...
#ifdef QB64_WINDOWS
 #include "..\\temp7\\dyninfo.txt"
#else
 #include "../temp7/dyninfo.txt"
#endif
}
...
#ifdef QB64_WINDOWS
 #include "..\\temp7\\clear.txt"
#else
 #include "../temp7/clear.txt"
#endif
...
//read COMMON data
#ifdef QB64_WINDOWS
 #include "..\\temp7\\inpchain.txt"
#else
 #include "../temp7/inpchain.txt"
#endif
...
#ifdef QB64_WINDOWS
 #include "..\\temp7\\chain.txt"
#else
 #include "../temp7/chain.txt"
#endif
...
switch(x){
#ifdef QB64_WINDOWS
 #include "..\\temp7\\onstrig.txt"
#else
 #include "../temp7/onstrig.txt"
#endif
//example.....
//case 1:
//...
...
switch(x){
#ifdef QB64_WINDOWS
 #include "..\\temp7\\onkey.txt"
#else
 #include "../temp7/onkey.txt"
#endif
//example.....
//case 1:
//...
...
#ifdef QB64_WINDOWS
 #include "..\\temp7\\ontimer.txt"
#else
 #include "../temp7/ontimer.txt"
#endif
//example.....
//case 1:
//...
...
#ifdef QB64_WINDOWS
 #include "..\\temp7\\maindata.txt"
 #include "..\\temp7\\runline.txt"
 #include "..\\temp7\\mainerr.txt"
 if (timer_event_occurred){
 timer_event_occurred--;
 #include "..\\temp7\\ontimerj.txt"
 }
 if (key_event_occurred){
 key_event_occurred--;
 #include "..\\temp7\\onkeyj.txt"
 }
 if (strig_event_occurred){
 strig_event_occurred--;
 #include "..\\temp7\\onstrigj.txt"
 }
 chain_input();
 #include "..\\temp7\\main.txt"
#else
 #include "../temp7/maindata.txt"
 #include "../temp7/runline.txt"
 #include "../temp7/mainerr.txt"
 if (timer_event_occurred){
 timer_event_occurred--;
 #include "../temp7/ontimerj.txt"
 }
 if (key_event_occurred){
 key_event_occurred--;
 #include "../temp7/onkeyj.txt"
 }
 if (strig_event_occurred){
 strig_event_occurred--;
 #include "../temp7/onstrigj.txt"
 }
 chain_input();
 #include "../temp7/main.txt"
#endif
