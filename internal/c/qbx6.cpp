...
#ifdef QB64_WINDOWS
 #include "..\\temp6\\regsf.txt"
 #include "..\\temp6\\global.txt"
#else
 #include "../temp6/regsf.txt"
 #include "../temp6/global.txt"
#endif
...
#ifdef QB64_WINDOWS
 #include "..\\temp6\\dyninfo.txt"
#else
 #include "../temp6/dyninfo.txt"
#endif
}
...
#ifdef QB64_WINDOWS
 #include "..\\temp6\\clear.txt"
#else
 #include "../temp6/clear.txt"
#endif
...
//read COMMON data
#ifdef QB64_WINDOWS
 #include "..\\temp6\\inpchain.txt"
#else
 #include "../temp6/inpchain.txt"
#endif
...
#ifdef QB64_WINDOWS
 #include "..\\temp6\\chain.txt"
#else
 #include "../temp6/chain.txt"
#endif
...
switch(x){
#ifdef QB64_WINDOWS
 #include "..\\temp6\\onstrig.txt"
#else
 #include "../temp6/onstrig.txt"
#endif
//example.....
//case 1:
//...
...
switch(x){
#ifdef QB64_WINDOWS
 #include "..\\temp6\\onkey.txt"
#else
 #include "../temp6/onkey.txt"
#endif
//example.....
//case 1:
//...
...
#ifdef QB64_WINDOWS
 #include "..\\temp6\\ontimer.txt"
#else
 #include "../temp6/ontimer.txt"
#endif
//example.....
//case 1:
//...
...
#ifdef QB64_WINDOWS
 #include "..\\temp6\\maindata.txt"
 #include "..\\temp6\\runline.txt"
 #include "..\\temp6\\mainerr.txt"
 if (timer_event_occurred){
 timer_event_occurred--;
 #include "..\\temp6\\ontimerj.txt"
 }
 if (key_event_occurred){
 key_event_occurred--;
 #include "..\\temp6\\onkeyj.txt"
 }
 if (strig_event_occurred){
 strig_event_occurred--;
 #include "..\\temp6\\onstrigj.txt"
 }
 chain_input();
 #include "..\\temp6\\main.txt"
#else
 #include "../temp6/maindata.txt"
 #include "../temp6/runline.txt"
 #include "../temp6/mainerr.txt"
 if (timer_event_occurred){
 timer_event_occurred--;
 #include "../temp6/ontimerj.txt"
 }
 if (key_event_occurred){
 key_event_occurred--;
 #include "../temp6/onkeyj.txt"
 }
 if (strig_event_occurred){
 strig_event_occurred--;
 #include "../temp6/onstrigj.txt"
 }
 chain_input();
 #include "../temp6/main.txt"
#endif
