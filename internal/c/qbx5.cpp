...
#ifdef QB64_WINDOWS
 #include "..\\temp5\\regsf.txt"
 #include "..\\temp5\\global.txt"
#else
 #include "../temp5/regsf.txt"
 #include "../temp5/global.txt"
#endif
...
#ifdef QB64_WINDOWS
 #include "..\\temp5\\dyninfo.txt"
#else
 #include "../temp5/dyninfo.txt"
#endif
}
...
#ifdef QB64_WINDOWS
 #include "..\\temp5\\clear.txt"
#else
 #include "../temp5/clear.txt"
#endif
...
//read COMMON data
#ifdef QB64_WINDOWS
 #include "..\\temp5\\inpchain.txt"
#else
 #include "../temp5/inpchain.txt"
#endif
...
#ifdef QB64_WINDOWS
 #include "..\\temp5\\chain.txt"
#else
 #include "../temp5/chain.txt"
#endif
...
switch(x){
#ifdef QB64_WINDOWS
 #include "..\\temp5\\onstrig.txt"
#else
 #include "../temp5/onstrig.txt"
#endif
//example.....
//case 1:
//...
...
switch(x){
#ifdef QB64_WINDOWS
 #include "..\\temp5\\onkey.txt"
#else
 #include "../temp5/onkey.txt"
#endif
//example.....
//case 1:
//...
...
#ifdef QB64_WINDOWS
 #include "..\\temp5\\ontimer.txt"
#else
 #include "../temp5/ontimer.txt"
#endif
//example.....
//case 1:
//...
...
#ifdef QB64_WINDOWS
 #include "..\\temp5\\maindata.txt"
 #include "..\\temp5\\runline.txt"
 #include "..\\temp5\\mainerr.txt"
 if (timer_event_occurred){
 timer_event_occurred--;
 #include "..\\temp5\\ontimerj.txt"
 }
 if (key_event_occurred){
 key_event_occurred--;
 #include "..\\temp5\\onkeyj.txt"
 }
 if (strig_event_occurred){
 strig_event_occurred--;
 #include "..\\temp5\\onstrigj.txt"
 }
 chain_input();
 #include "..\\temp5\\main.txt"
#else
 #include "../temp5/maindata.txt"
 #include "../temp5/runline.txt"
 #include "../temp5/mainerr.txt"
 if (timer_event_occurred){
 timer_event_occurred--;
 #include "../temp5/ontimerj.txt"
 }
 if (key_event_occurred){
 key_event_occurred--;
 #include "../temp5/onkeyj.txt"
 }
 if (strig_event_occurred){
 strig_event_occurred--;
 #include "../temp5/onstrigj.txt"
 }
 chain_input();
 #include "../temp5/main.txt"
#endif
